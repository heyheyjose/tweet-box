...
var TweetBox = React.createClass({
	...
	getInitialState: function getInitialState() {
		// this "special" function sets up the initial state of a component and runs only once during the lifecycle of the component
		return {
			text: '',
			photoAdded: false
		};
	...
	remainingChar: function remainingChar() {
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				'button',
				{ className: 'btn btn-default pull-left', onClick: this.togglePhoto },
				this.state.photoAdded ? "Photo Added" : "Add Photo"
			),
			React.createElement(
				'button',
				{ className: 'btn btn-primary  pull-right', disabled: this.remainingChar() === 140 },
				'Tweet'
			),
			React.createElement(
				'span',
...
React.render(React.createElement(TweetBox, null), document.getElementById('tweet-box'));
